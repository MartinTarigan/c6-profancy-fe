...
export default function TambahLogLembur() {
  ...
  const handleOutletChange = (value: string) => {
    const selectedOutlet = outlets.find((outlet) => outlet.outletId === Number.parseInt(value))
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-blue-600">Tambah Log Lembur</h1>
          ...
          <div className="lg:col-span-1 space-y-6">
            <Card className="p-6">
              <div className="text-center space-y-4">
                ...
                <div>
                  <h3 className="font-semibold text-gray-900">Form Log Lembur</h3>
                  <p className="text-sm text-gray-600 mt-1">
                    Lengkapi semua informasi yang diperlukan untuk mencatat waktu lembur Anda
                  </p>
                </div>
              </div>
            </Card>
              ...
              <Card className="p-6 border-blue-200 bg-blue-50">
                <div className="flex items-start gap-3">
                  ...
                  <div className="space-y-2">
                    <h4 className="font-semibold text-blue-900">Outlet Terpilih</h4>
                    <div className="space-y-1 text-sm">
                      <p className="text-blue-800">
                        <span className="font-medium">Nama:</span> {currentOutlet.name}
                      </p>
                      <p className="text-blue-800">
                        <span className="font-medium">Headbar:</span> {currentOutlet.headBarName || "Tidak Ada"}
                      </p>
                    </div>
                  </div>
                </div>
            ...
            {/* Guidelines */}
            <Card className="p-6">
              <h4 className="font-semibold text-gray-900 mb-3">Panduan Pengisian</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div>
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="dateOvertime" className="text-sm font-medium text-gray-700">
                        Tanggal Lembur
                      </Label>
                      <Input
                        id="dateOvertime"
                        ...
                        // biar hanya memilih tanggal hingga hari ini, ex: "2025-06-04T12:00:00.000Z"
                        // ubah format ke tahun, bulan, tanggal, jam, menit, detik, dan zona waktu, terus split sampe T (time)
                        // ambil index [0] untuk mendapatkan tanggal saja
                        required
                        className="h-11"
                      />
                    </div>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Lokasi & Durasi</h3>
                  </div>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <Label htmlFor="outletId" className="text-sm font-medium text-gray-700">
                        Outlet
                      </Label>
                      <Select value={formData.outletId} onValueChange={handleOutletChange}>
                ...
                <div>
                  <div className="flex items-center gap-2 mb-6">
                    ...
                    <h3 className="text-lg font-semibold text-gray-900">Detail & Verifikasi</h3>
                  </div>
                  <div className="space-y-6">
                    <div className="space-y-2">
                      ...
                      <div className="flex justify-between text-xs">
                        <span className="text-gray-500">Maksimal 50 karakter</span>
                        <span
                          className={`font-medium ${formData.reason.length > 40 ? "text-orange-600" : "text-gray-600"}`}
                        >
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="verifier" className="text-sm font-medium text-gray-700">
                        Verifikator
                      </Label>
                      <div className="relative">
                        <Input
        ...
        <div className="fixed top-4 right-4 z-50 animate-in slide-in-from-top-2">
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <AlertDescription className="flex-1 font-medium">{toast.message}</AlertDescription>
              <Button
                variant="ghost"
                size="sm"
