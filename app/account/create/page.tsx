...
export default function TambahAkunBaru() {
  ...
  const validateForm = () => {
    ...
    } else if (["Head Bar", "Barista", "Trainee Barista", "Probation"].includes(role) && !outlet) {
      ...
      <div className="flex flex-col items-center">
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-4xl border border-gray-200 rounded-lg p-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select id="role" className="w-full border border-gray-300 rounded-lg p-2.5 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-primary" value={role} onChange={(e) => setRole(e.target.value)}>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select id="outlet" className="w-full border border-gray-300 rounded-lg p-2.5" value={outlet} onChange={(e) => setOutlet(e.target.value)} disabled={["Admin", "CEO", "CIO", "CMO"].includes(role)}>
              ...
              <div className="space-y-2">
                ...
                <input type="text" id="nama" className="w-full border border-gray-300 rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-primary" value={nama} onChange={(e) => setNama(e.target.value)} />
                {errors.nama && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select id="gender" className="w-full border border-gray-300 rounded-lg p-2.5 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-primary" value={gender} onChange={(e) => setGender(e.target.value)}>
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                ...
                <input type="text" id="phone" className="w-full border border-gray-300 rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-primary" value={phone} onChange={(e) => setPhone(e.target.value)} />
                {errors.phone && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input type="text" id="birthdate" placeholder="01/01/2001" className="w-full border border-gray-300 rounded-lg p-2.5 pl-10 focus:outline-none focus:ring-2 focus:ring-primary" value={birthdate} onChange={(e) => setBirthdate(e.target.value)} />
              ...
              <div className="space-y-2">
                ...
                <input type="text" id="address" placeholder="Jl. " className="w-full border border-gray-300 rounded-lg p-2.5 focus:outline-none focus:ring-2 focus:ring-primary" value={address} onChange={(e) => setAddress(e.target.value)} />
                {errors.address && (
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <select id="status" className="w-full border border-gray-300 rounded-lg p-2.5 pr-10 appearance-none focus:outline-none focus:ring-2 focus:ring-primary" value={status} onChange={(e) => setStatus(e.target.value)}>
          ...
          <div className="flex justify-center gap-4 mt-10">
            ...
            <Button className="w-40" onClick={handleSubmit} disabled={!isValid}>
              Simpan Akun
            </Button>
          </div>
        </form>
